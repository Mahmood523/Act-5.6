...
public class Announcement implements Serializable {
	...
	public Announcement(Long announcementId, String title, String description, Category category, double price,
	...
	public Announcement(Long announcementId, String title, String description, double price, byte[] picture,
